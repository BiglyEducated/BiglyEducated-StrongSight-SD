...
class ExerciseLibrary {
  static final Map<String, ExerciseConfig> configs = {
    ...
    'row': ExerciseConfig(
      name: "Barbell Row",
      vertexJoint: PoseLandmarkType.leftHip,
      pointA: PoseLandmarkType.leftKnee,
      pointB: PoseLandmarkType.leftWrist,
      standingThreshold: 135.0,
      bottomThreshold: 90.0,
      optimalAngle: "Front",
      cameraHeight: "Waist Height",
      readyCue: "Hinge forward. Arms hang straight.",
      descentCue: "Lower with control.",
      bottomCue: "Full extension. Next rep",
      ascentCue: "Pull! Drive elbows back!",
      repCompleteCue: "Bar at torso! Squeeze and hold.",
    ),
